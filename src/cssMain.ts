 ...
 *  Modified work Copyright 2017 Bryan Phelps.
 *
...
function validateTextDocument(textDocument: TextDocument): void {
    ...
    let diagnostics = getLanguageService(textDocument).doValidation(textDocument, stylesheet, { lint: null, validate: false });
